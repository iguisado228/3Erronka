...
CREATE TABLE `erreserba` (
  ...
  CONSTRAINT `fk_erreserba_bazkidea1` FOREIGN KEY (`idBazkidea`) REFERENCES `bazkidea` (`idBazkidea`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `fk_erreserba_eremua1` FOREIGN KEY (`idEremua`) REFERENCES `eremua` (`idEremua`),
  CONSTRAINT `fk_erreserba_kluba1` FOREIGN KEY (`idKluba`) REFERENCES `kluba` (`idKluba`) ON DELETE SET NULL ON UPDATE SET NULL
...
-- Dump completed on 2025-04-01 10:05:39
